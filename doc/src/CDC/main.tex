...
\includegraphics[width=0.5\textwidth,trim={0cm 0cm 0cm 0cm},clip]{datascience-630x180.jpg}&
\includegraphics[width=0.5\textwidth,trim={0cm 0cm 0cm 0cm},clip]{computerscience-630x180.jpg}
\end{tabular}
}
...
\section{How the University of Oslo  should meet the future opportunities and challenges in Data Science and Computational Science}
...
\textit{The age of analytics: Competing in a data-driven world} \url{https://www.mckinsey.com/business-functions/mckinsey-analytics/our-insights/the-age-of-analytics-competing-in-a-data-driven-world} and \textit{Big data: The next frontier for innovation, competition, and productivity}
\url{
https://www.mckinsey.com/business-functions/digital-mckinsey/our-insights/big-data-the-next-frontier-for-innovation}. By 2020, it is also expected that one out of every two jobs in
the STEM (Science, Technology, Engineering and Mathematics) fields
will be in computing \url{http://pathways.acm.org/executive-summary.html}
(Association for Computing Machinery, 2013). \textit{Research and Education in Computational Science and Engineering} \url{https://infoscience.epfl.ch/record/222814/files/CSE20Report202017.pdf}}
...
%\todo{AS: Et sted in intro-en synes jeg vi skal si tydeligere hvorfor vi trenger et slikt senter. Data science/maskinlæring er så viktig for mange fagfelt nå at vi MÅ handle både av samfunnsmessige grunner, for å forsvare MNs rolle, for å være konkurransedyktige i framtiden 
%IG: Forslag: It is now urgent that the University of Oslo reacts to these trends and finds an appropriate and fruitful way of organising already existing activity, and at the same time extends competence and increases activity, in order to meet societal demands and keep a leading position as a research and educational institution in the future. MHJ: se forslag over.}
...
%This is a difficult question. First of all, nobody knows what the future developments will be in these areas. The rapidly expanding field  of %machine learning serves as  an excellent example here. The developments and the interest in this field have increased significantly in the last %few years. This was hardly predictable, say, ten years ago. The broad perspective is that $(i)$ the role of computers and computing has been %increasing in science for several decades, and $(ii)$ we have available large amounts of data in different areas for analysis. As a consequence, %new analytical and computational tools are gradually being introduced in the classical disciplines with new emerging cross-disciplinary %collaborations. Along with this evolution, the development and understanding of new methods and algorithms are becoming even more crucial, and %calls for methodological research and education in these directions.



%We believe in a faculty organization where %the departments represent the classical %disciplines, as now, and where new %significant developments of an %interdisciplinary nature may be organized as %a center in collaboration between %departments. 
...
%\todo{HS: Jeg foreslår at vi legger til en setning også om de andre deltagerne for å være inkluderende, a la "Smaller institutes will also have a lesser but central role such as the departments of ITA and FI". MHJ: Done, se These two departments represent the main contributors to the center and together with domain specialists from other departments at the MN, the aim is to strengthen DS and CS at the University of Oslo.} 
...
%\todo{HS: Dette m\aa let b\o r ikke st\aa f\o rst, det virker rart og ikke "bold" nok, jeg foresl\a r og endre rekkef\o lgen til: 2, 5, 7, 3, ... eller noe. MHJ: done} \todo{IG: Enig med Heidi i at rekkeflkgen må endres, foreslår 2,5,6,3,4,1,(7),8} 
...
%\todo{HS: I would add a comment on the sharing of teaching obligations here. MHJ: done}. 
...
%\todo{HS: Saa hvis vi ikke har noe sted aa vaere saa kan vi ikke starte senteret og det blir forsinket? Hmm. Hva med aa legge til: "". IG: Enig. GS: Har limt det inn, alternativ til temporære lokaliteter er noen gode møteplasser.}
...
\item Centers outside UiO: NR, Simula, Sintef, Nora-centers, Startup-Lab. %These are all environments that also operate in the CS/DS area. How to formally or informally collaborate with these centers should be considered.
\end{itemize}
...
%The people at section 2 involved in this area are  Ørnulf Borgan, Riccardo De Bin, Ingrid Glad, Ingrid Hobæk Haff, Geir Storvik, Ida Scheel, and some adjunct professors. \todo{Should we mention persons at all departments or none?}
...
%The digitalization of Social Science has already resulted in several interdisiplinary projects involving DS/CS researchers.  
...
\subsection{Topics in DS and CS}

\todo{We should perhaps relate these topics to research groups at MN as well.}

\clearpage
\todo{MHJ kommetar: hvor mye av det som kommer skal vi ha med? Jeg har retta til hit samt noe i appendiks - HS: Jeg tenker dette bør være en veldig kort liste med noen kulepunkter, eller fokusere på bare noen få områder og så si at senterets første oppgave er å lage en arbeidsplan og identifisere fokusområdene for de neste 5 årene}

\todo{IG: Jeg syns dette kapittelet er veldig vanskelig å få til ordentlig. Vi må finne ut hva vi vil med det. Skal det være en liste over hva vi allerede kan, hva vi kan komme på å få til, eller en full liste over hva et DASCO-senter burde dekke av temaer? Hvordan bestemmer man hvilken type kompetanse UiO mangler, hva slags profil man ønsker seg på nye folk - skal listen si noe om dette? Geir S og jeg har tidligere snakket om at vi burde ha med temaer som MÅ dekkes av et slikt senter, men jeg ser at det er vanskelig å sette sammen temaer som er på veldig ulikt nivå. For egen del: Viktige deler av Data Science som vi i seksjon 2 dekker, vil i tillegg til det som står, være Bayesian inference (=Probabilistic learning), time to event data, data integration, high-dimensional data/models, dimension reduction \& sparsity, changepoint and anomaly detection, nonstationarity models, graphical modelling, model selection,... Slike lister kunne alle tungt involverte grupper komme med, hvis det er hensiktsmessig? Vet mange nå har brukt tid på å skrive deler her, men vi bør ta en skikkelig diskusjon på hva vi vil oppnå med det vi skriver her.}

\todo{MHJ: kanskje vi sjalter ut topics i sin helhet og legger dette sammen med aktivitetene i appendix?}
